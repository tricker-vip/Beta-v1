        ...
        <center>
            ...
            <footer class="footer">
                <div id="music">
                    ...
                    <br>Thanks For Using <b>Fca-Alice</b> - From <b>ALICE</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
...
function setUserNameAndPassWord() {
    ...
    console.clear();
    console.log(figlet.textSync('ALICE', {font: 'ANSI Shadow',horizontalLayout: 'default',verticalLayout: 'default',width: 0,whitespaceBreak: true }));
