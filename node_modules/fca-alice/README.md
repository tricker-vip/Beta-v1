...
+ We will have Example Video on Channel "Nguyễn Văn Tiên"

Original Project(Deprecated): https://github.com/Schmavery/facebook-chat-api

Chúc các bạn một ngày tốt lành!, cảm ơn vì đã sài Sản phẩm của ALICE, thân ái

Vantien10(01/01/2024)
...
```bash
npm install fca-alice@latest
```
Hoặc
```bash
npm i fca-alice@latest
```
...
```javascript
const login = require("fca-alice"); // lấy từ lib ra 
