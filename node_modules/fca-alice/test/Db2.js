...
if (!fs.existsSync(process.cwd() + '/ALICE_DATA')) {
    fs.mkdirSync(process.cwd() + '/ALICE_DATA');
    fs.writeFileSync(process.cwd() + '/ALICE_DATA/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/ALICE_DATA/SyntheticDatabase.sqlite");
